...
---
## About project
Answer business question: a high-tech company, Bellabeat, that manufactures health-focused smart products wants to analyze smart device usage data in order to gain insight into how non-Bellabeat consumers are already using their smart devices.
...
a)The dataframe 'daily_calories', 'daily_intensities', and 'daily_steps', all have duplicate datasets which are contained in the 'daily_activity' dataframe.
